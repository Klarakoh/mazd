...
PYEXTRA_DIR_SP = '/data/pyextra_sp'
...
def install_dep(spinner):
  ...
  dup = 'cp -rf /data/openpilot/pyextra /data/pyextra_sp'
...
if __name__ == "__main__" and (OPSPLINE_SPEC is None or OVERPY_SPEC is None):
  ...
  if os.path.exists(PYEXTRA_DIR_SP):
    ...
    command = 'rm -rf /data/openpilot/pyextra; cp -rf /data/pyextra_sp /data/openpilot/pyextra'
    process = subprocess.Popen(command, stdout=subprocess.PIPE, shell=True)
    print("SP_LOG: Removed directory /data/openpilot/pyextra")
    print("SP_LOG: Copied /data/pyextra_sp to /data/openpilot/pyextra")
  else:
